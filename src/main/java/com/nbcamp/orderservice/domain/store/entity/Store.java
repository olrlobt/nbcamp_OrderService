...
public class Store extends BaseTimeEntity {
	...
	@Comment("varchar comment 매장이름")
	private String name;

	@Enumerated(EnumType.STRING)
	@Column(name = "store_category", nullable = false)
	@Comment("varchar comment 매장 카테고리")
	private StoreCategory storeCategory;

	@Column(name = "area", nullable = false)
	@Comment("varchar comment 지역")
	private String area;

	@Column(name = "address", nullable = false)
	@Comment("varchar comment 주소")
	private String address;

	@Column(name = "call_number", nullable = false)
	@Comment("varchar comment 전화번호")
	private String callNumber;

	@Column(name = "store_grade", nullable = false)
	@Comment("double precision comment 매장 평점")
